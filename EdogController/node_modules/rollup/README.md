...
rollup 3d_model_rendering.js --format iife --name "myBundle" --file bundle.js
```
...
rollup 3d_model_rendering.js --format cjs --file bundle.js
```
...
rollup 3d_model_rendering.js --format umd --name "myBundle" --file bundle.js
```
